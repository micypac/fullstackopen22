...
describe('most likes', () => {
  ...
  test('of only one blog, equals the likes value of itself', () => {
...
// const list = [{ property: 'foo', value: 1 }, { property: 'foo', value: 3 }, { property: 'bar', value: 2 }, { property: 'bar', value: 3 }, { property: 'chu', value: 8 }]
// const result = _(list)
//   .groupBy('property')
//   .map((item, id) => ({
//     property: id,
...
//     if (currValue['likes'] >= prevValue['likes']) {
//       prevValue = currValue
//     }
//     return prevValue
//   }, { author: 'none', likes: 0 })
