describe('Blog app', () => {
  ...
  describe('Login', function () {
    ...
    it('fail with wrong credentials', function () {
      ...
      cy.get('html').should('not.contain', 'Michael Pacleb logged in')
    })
  })
  ...
  describe('When logged in', function () {
    ...
    describe('A blog exist', function () {
      ...
      it('a blog can be liked', function () {
        cy.contains('Another Blog Post Wanda Maximoff')
          .parent()
          .find('#toggle-button')
          .click()
        cy.contains('Another Blog Post Wanda Maximoff')
      ...
      it('a blog can be removed but window confirm cancelled', function () {
        ...
        cy.on('window:confirm', function (str) {
          expect(str).to.equal(
            'Remove blog Another Blog Post by Wanda Maximoff',
          )
        })

        cy.on('window:confirm', () => false)
        cy.get('html').should('contain', 'Another Blog Post Wanda Maximoff')
      })
      ...
      it('a blog can be removed and window confirmed', function () {
        ...
        cy.get('html').should('not.contain', 'Another Blog Post Wanda Maximoff')
      })
    })
    ...
    describe('Several blogs exist', function () {
      ...
      it('several blogs can be liked', function () {
        cy.contains('Blog Post 2 Steve Rogers')
          .parent()
          .find('#toggle-button')
          .click()
        cy.contains('Blog Post 2 Steve Rogers')
        ...
        cy.contains('Blog Post 3 Stephen Strange')
          .parent()
          .find('#toggle-button')
          .click()
        cy.contains('Blog Post 3 Stephen Strange')
  ...
  describe('Unauthorized blog deletion', function () {
    it("blog can't be deleted by other users", function () {
      ...
      cy.contains('Blog Post 1 Tony Stark')
        .parent()
        .find('#toggle-button')
        .click()
      cy.contains('Blog Post 1 Tony Stark')
